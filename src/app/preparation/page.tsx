      ...
      <section className="py-14 md:py-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <WhatsAppGroupLink source="preparation" className="mt-4 inline-flex items-center gap-2 px-8 py-3 rounded-lg bg-[#25D366] text-white text-base font-semibold hover:brightness-110 transition-all shadow-md" />
          </div>
        </div>
      </section>
