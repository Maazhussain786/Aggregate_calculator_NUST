        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="mt-8 card p-4 sm:p-5 max-w-xl mx-auto border border-[var(--accent-primary)] bg-[var(--accent-light)]">
              ...
              <WhatsAppGroupLink source="homepage" className="mt-3 flex items-center justify-center gap-2 w-full py-2.5 rounded-lg bg-[#25D366] text-white text-sm font-semibold hover:brightness-110 transition-all" />
            </div>
          </div>
        </div>
      </section>
