        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-none space-y-6 text-[var(--text-secondary)]">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                <strong className="text-[var(--text-primary)]">Calculator Input:</strong> The scores you enter 
                (NET, FSc, Matric) are processed locally in your browser and are not stored on our servers.
              </li>
              <li>
                <strong className="text-[var(--text-primary)]">Contact Form:</strong> If you submit a contact form, 
                we collect your name, email, and message to respond to your inquiry.
              </li>
              <li>
                <strong className="text-[var(--text-primary)]">Analytics:</strong> We may use anonymous analytics 
            ...
            <h2 className="text-xl font-semibold text-[var(--text-primary)]">Data Storage</h2>
            <p>
